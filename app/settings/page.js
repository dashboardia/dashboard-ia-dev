...
import { getPublicOperationalAccessEnabled } from "../../lib/public-operational-access";
import { getWorkerRuntimeStatus } from "../../lib/worker-heartbeat";
import GlobalSettingsForm from "./global-settings-form";
import PublicAccessControl from "./public-access-control";
...
export default async function SettingsPage() {
  ...
  const publicAccessEnabled = user.globalRole === "ADMIN" && configuration.database ? await getPublicOperationalAccessEnabled().catch(() => true) : null;
