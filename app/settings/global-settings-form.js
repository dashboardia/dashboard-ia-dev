    ...
    <form className="form-card detail-card full-card" onSubmit={submit}>
      ...
      <div className="financial-settings">
        ...
        <div className="form-grid three-columns">
          ...
          <label><span>Custo por ambiente (créditos)</span><input name="environmentCreditCost" type="number" min="0" max="100000" value={form.environmentCreditCost} onChange={change} /><small>Valor cobrado ao iniciar e estornado automaticamente se a publicação falhar.</small></label>
