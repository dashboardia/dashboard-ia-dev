...
import { loginReturnPath, repositoryAuthorizationReturnPath, safeInternalReturnPath, withReturnState } from "./return-navigation";
...
describe("return navigation", () => {
  ...
  it("recupera a tela de origem quando o GitHub volta diretamente para a home", () => {
    expect(repositoryAuthorizationReturnPath({}, "/projects/new", { allowRemembered: true })).toBe("/projects/new");
    expect(repositoryAuthorizationReturnPath({}, null, { allowRemembered: true })).toBeNull();
  });
});
