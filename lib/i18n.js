export const messages = {
  "pt-BR": {
    ...
    saved: "Preferências salvas.", support: "Assistente do Dashboardia", supportIntro: "Tire dúvidas sobre o uso da plataforma.", supportUnavailable: "Não foi possível responder agora.",
