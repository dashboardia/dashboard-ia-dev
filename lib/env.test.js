...
describe("runtime security configuration", () => {
  ...
  it("exige banco, OpenAI, criptografia e host isolado no worker", () => {
    expect(runtimeSecurityConfigurationErrors("worker", secureWorkerConfiguration)).toEqual([]);
    ...
    expect(runtimeSecurityConfigurationErrors("worker", {
      ...
      "PREVIEW_HOST_URL é obrigatória",
      "PREVIEW_HOST_TOKEN é obrigatória",
