...
import { synchronizedPreviewRepairError } from "./preview-repair-consent.js";
import { preserveManualPreviewStop } from "./preview-stop-reason.js";
...
export async function persistDashboardiaPreviewState(database, environment, remote) {
  ...
  const data = {
    ...
    error: preserveManualPreviewStop(
      environment.error,
      synchronizedPreviewRepairError(environment.error, remote.error, nextStatus),
      nextStatus,
    ),
    readyAt,
    lastHeartbeatAt: now,
