...
export async function getDashboardData(user) {
  ...
  const [projects, recentDemands, activeDemands, executionsToday, successfulToday, healthCheckCount, healthyHealthCheckCount, recentHealthChecks] = await Promise.all([
    db.project.findMany({
