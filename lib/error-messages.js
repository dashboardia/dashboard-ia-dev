...
const rules = [
  ...
  {
    match: /tentativas autom[aá]ticas atingiram o limite total de seguran[cç]a/i,
    title: "As três tentativas automáticas foram utilizadas",
    message: "A IA chegou ao limite controlado deste ciclo sem conseguir finalizar uma correção executável.",
    action: "Revise o diagnóstico e autorize um novo ciclo somente se quiser continuar nesta mesma demanda.",
  },
  {
    match: /PROJECT_ASSETS_NOT_INTEGRATED|recebeu e copiou os anexos.*não os vinculou/i,
    title: "Os anexos foram preservados, mas não aplicados",
    message: "Os arquivos chegaram ao projeto, porém a IA não conseguiu vinculá-los ao produto após as tentativas automáticas.",
    action: "Continue nesta mesma branch com uma instrução mais específica; não é necessário reenviar os arquivos.",
  },
  {
  ...
  {
    match: /validação runtime falhou|validação funcional|comando de preview foi encerrado|não ficou disponível dentro de 90 segundos/i,
    title: "A aplicação não iniciou corretamente",
    message: "O código passou pelas etapas anteriores, mas não respondeu como uma aplicação navegável.",
    action: "A IA receberá o erro real de inicialização nas tentativas automáticas antes de solicitar sua decisão.",
  },
  {
