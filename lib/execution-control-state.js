...
export function executionControlState(execution, preview = execution?.previewEnvironment ?? null) {
  ...
  return { status, displayStatus, displayTone, environmentStatus, previewState, previewReady, awaitingEnvironment, interactionAvailable, creditBlocked, canPause, canResume, canCancel, canRestartEnvironment };
}
