...
import { claimNextExecution, clientInteractionRequeueData, queueDemandExecution, recoverStaleExecutions } from "./executions";
...
describe("execution queue", () => {
  it("concede um novo orçamento de tentativas ao ajuste solicitado pelo cliente", () => {
    ...
    expect(clientInteractionRequeueData({ now, timeoutMinutes: 120 })).toEqual({
      ...
      conversationExpiresAt: new Date("2026-08-21T01:30:00.000Z"),
      error: null,
    });
  });
