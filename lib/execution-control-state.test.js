...
test("não oferece uma segunda pausa enquanto a primeira está sendo processada", () => {
  const state = executionControlState(execution({ status: "RUNNING", stopRequestedAt: new Date() }));
