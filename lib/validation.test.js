...
describe("globalSettingsSchema", () => {
  ...
  it("aceita de uma a cinco execuções paralelas", () => {
    ...
    expect(globalSettingsSchema.parse({ ...base, nodeMemoryMb: 768, parallelExecutions: 5 }).parallelExecutions).toBe(5);
    expect(() => globalSettingsSchema.parse({ ...base, parallelExecutions: 6 })).toThrow("cinco execuções");
  });
